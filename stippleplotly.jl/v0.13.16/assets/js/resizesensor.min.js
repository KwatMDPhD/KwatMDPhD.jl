          ...
          var b = function () {
              (v = 0),
                m &&
                  ((w = z.width),
                  (g = z.height),
                  e.resizedAttached && e.resizedAttached.call(z));
            },
            A = function () {
              (z = o(e)),
                (m = z.width !== w || z.height !== g) && !v && (v = t(b)),
                S();
            },
            x = function (e, t, n) {
              e.attachEvent
    ...
    (s.detach = function (e, t) {
      i(e, function (e) {
        e &&
          ((e.resizedAttached &&
            "function" == typeof t &&
            (e.resizedAttached.remove(t), e.resizedAttached.length())) ||
            (e.resizeSensor &&
