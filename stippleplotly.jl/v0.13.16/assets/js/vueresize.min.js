!(function (t, e) {
  "object" == typeof exports && "object" == typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(
          ["css-element-queries/src/ResizeSensor.js", "lodash.debounce"],
          e,
        )
    ...
    function (t, e, n) {
      ...
      !(function (s, u) {
        ...
        function s(t) {
          ...
          return (r = r || _), { delay: r, initial: n };
        }
        function u(t, e) {
          var n = { root: document.documentElement },
          ...
          switch (r) {
            ...
            case "throttle":
              i = v(
                ...
                o.delay,
                { leading: !0, trailing: !0, maxWait: o.delay },
              );
          }
        ...
        function a(t, e, n) {
          ...
          if (!r || "function" != typeof r)
            return void console.warn(
              "v-resize should received a function as value",
            );
          var l = s(i);
          return (
            h &&
              h.$el === t &&
              h.$once("hook:deactivated", function () {
                f(t),
                  h.$once("hook:activated", function () {
                    a(t, { value: r, arg: o, modifiers: i }, { context: h });
                  });
              }),
            t.offsetParent
              ? void c(t, { value: r, arg: o, options: l })
              : ((l.initial = !0),
                void (t.__visibility__listener__ = u(t, function () {
                  return c(t, { value: r, arg: o, options: l });
                })))
          );
        }
        function f(t) {
          t.__visibility__listener__ && t.__visibility__listener__.disconnect(),
            t.resizeSensor && l.default.detach(t);
        }
        ...
        var h = i(n),
          ...
          _ = 150;
        (e.default = { inserted: a, unbind: f }), (t.exports = e.default);
      });
    },
    function (t, e) {
        ...
        (r.prototype.THROTTLE_TIMEOUT = 100),
          ...
          (r.prototype._unmonitorIntersections = function () {
            this._monitoringIntersections &&
              ...
              u(t, "resize", this._checkForIntersections, !0),
