  ...
  plotlyInstances.forEach((plotlyInstance) => {
    ...
    attributeNames.forEach((attributeName) => {
      ...
      if (literalAttribute != null && boundAttribute != null) {
        throw new Error(
          "Both bound and literal attribute found for " +
            attributeName +
            ". Only one is allowed.",
        );
      }
      ...
      if (literalAttribute != null) {
        ...
        try {
          ...
          if (
            (literalAttribute.startsWith("{") &&
              literalAttribute.endsWith("}")) ||
            ...
            throw new Error(
              "Invalid literal attribute for " +
                attributeName +
                ". Expected a base64-encoded JSON string, or a valid JS object.",
            );
          }
        }
      }
...
const regex = /-(\w)/g,
  methods = plotlyFunctions.reduce(
    (e, t) => (
      (e[t] = function (...e) {
  ...
  camelize = cached((e) =>
    e.replace(regex, (e, t) => (t ? t.toUpperCase() : "")),
  ),
  directives = {};
  ...
  Vue.component("plotly", {
    ...
    computed: {
      options() {
        return {
          responsive: !1,
          ...Object.keys(this.$attrs).reduce(
            (e, t) => ((e[camelize(t)] = this.$attrs[t]), e),
            {},
          ),
        };
      },
